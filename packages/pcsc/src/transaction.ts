...
import type { Card, CardStatus, CardStatusOwned } from './card.ts';
import { Disposition } from './enums.ts';
import type { ShareMode, Protocols, Attribute } from './enums.ts';
import { checkResult } from './error.ts';
